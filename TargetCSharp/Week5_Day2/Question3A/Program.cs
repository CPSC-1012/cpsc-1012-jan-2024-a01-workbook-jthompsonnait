...
// Read the user's input and try to convert it to an integer. If conversion fails, print an error message.
...
else
{
    ...
    // Determine the game's outcome using nested ternary operators based on the user's and computer's choices
    if (userChoice == 0)
    {
